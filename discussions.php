...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0"/>
	<title>Discussions - ConfessionWeb</title>
...
<div class="container">
  <h3><img height="40px" width="40px" src="https://png.icons8.com/color/96/000000/chat.png">Discussions Room</h3>

<p class="text-muted">Ask the ConfessionWeb community for their opinions, views and advice on various topics.</p>
<br>
...
<li class="nav-item">
    <a style="background-color: #e4e4e4; border-radius: 7px; line-height: 4px;" id="hover" class="nav-link text-muted" href="discussions.php"><img height="20px" width="20px" src="https://png.icons8.com/color/96/000000/chat.png">&nbsp;Discussions<span class="badge"><?php 
$id = isset($_SESSION['id']);
...
<div>
        ...
        <b><p class="card-text text-muted">
 ...
 <uL>       
        ...
        <li style="list-style-type: none;"><img class="img-fluid" style="border-radius: 50%; width: 45px; height: 45px; float: left; margin-right: 5px;" src="<?php echo $location; ?>"></li>
...
<?php
            ...
            ?>
            <li><img class="img-fluid" style="border-radius: 50%; width: 45px; height: 45px; float: left; margin-right: 15px;" src="image/unknown2.png"></li>
 ...
 ?>
        ...
        <span style="font-family: 'Merriweather', serif;" class="text-muted" style="margin-top: 8px;">
          
<form action="discussion_post.php" method="post" class="form-inline my-2 my-lg-0">
  <li style="list-style-type: none;"><input class="form-control mr-sm-2" type="text" name="dis_post" placeholder="Express what you want and think..." style="max-width: 400px; height: 33px; margin-top: 8px;"></li>
  <input type="submit" class="btn btn-danger btn-sm" style="background-color: red; margin-top: 8px;" value="Submit">
</form>
...
<?php $sql = "SELECT * FROM signup INNER JOIN discussions ON signup.name = discussions.name ORDER BY discussions.dis_id DESC";
$result = $conn->query($sql);
...
<?php } ?>
        ...
        <div class="text-muted" style="font-size: 11px; margin-left: 7px;"><i class="far fa-clock"></i>&nbsp;<?php echo time_ago_in_php($dis_time);?></div>
        
    </h5>
    
  </div>

<p class="card-text" ><img width="20px" height="20px" src="https://png.icons8.com/color/96/000000/telegram-app.png"><?php echo $row["dis_post"]; ?></p>
...
<?php 
    ...
    echo "<br>"."<center style='font-size: 25px;'>"."<img width='30px' height='30px' src='https://png.icons8.com/color/96/000000/no-chat.png'>"."No Discussions happened yet!!"."</center>";
}
