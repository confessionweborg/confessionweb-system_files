...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top sticky">
...
if ($result->num_rows > 0) {
   ...
   ?>
              ...
              <img src="<?php echo $row['image']; ?>" class="user-image" alt="<?php echo $username ?>">

<?php 
    
            }
} else {
    echo "<a href = 'signin.php'>"."Please Login".'</a>';
}
?>
...
<?php 
    ...
    echo "Please signin to view your profile!";
}
?>
...
?>
        ...
        <div class="pull-left info">
          <a href="profile.php"><p><?php echo "$username" ?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          <a href="home.php">
            <i class="fa fa-newspaper"></i> <span>News Feed</span>
        ...
        <li class="treeview">
          ...
          <li><a href="profile.php?id='<?php echo $id; ?>'"><i class="fa fa-user-circle"></i> <span>Profile</span></a></li>
    
          <li><a href="user_blog.php"><i class="fa fa-rss"></i> <span>Blogs</span></a></li>
...
</i><li class="header" style="font-size: 15px; color: white;"><i style="color: white;" class="fa fa-assistive-listening-systems"></i>&nbsp;&nbsp;Trending Confessions</li>

<?php 

$sql6 = "SELECT * FROM posts ORDER BY views desc LIMIT 3";
...
if ($result6->num_rows > 0) {
   ...
   ?>
        ...
        <li><a href="post_view.php?id='<?php echo $id; ?>'"><i class="fa fa-circle-o text-red"></i> <span style="font-size: 13px;"><?php echo $title." (" ?><?php echo $views." Views)"?></span></a>
</li>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Write Your Confession</h3>
              <!-- tools box -->
...
<hr style="width= 50%; color:#f3f6db;">
<section class="class="col-lg-2 connectedSortable">
<center>
  
<h3><i class="fa fa-rss"></i>&nbsp;&nbsp;Recommended Blogs for You</h3>

</center>
<hr style="color: black;" width="50%">

<?php $sql = "SELECT * FROM blogpost ORDER BY RAND() LIMIT 2";
...
if ($result->num_rows > 0) {
  ...
  <div class="px-2 py-2">
    <p style="font-size: 15px;" class="mb-0 small font-weight-medium text-uppercase mb-0 lts-2px">
      <i class="fa fa-edit"></i>&nbsp;<?php echo "Blog post by ".$row["name"]; ?>
    </p>
  <div style="font-size: 15px;" class="card-footer text-muted"><hr><i class="far fa-clock"></i>&nbsp;<?php echo time_ago_in_php($btime);?></div>



    <a href="blog_view.php?id='<?php echo $id; ?>'"><h1 class="ff-serif font-weight-normal text-black card-heading mt-0 mb-1" style="line-height: 1.25;">
      <i class="fa fa-link"></i>&nbsp;<?php echo $row["btitle"]; ?>
    </h1></a>
...
<?php 
    ...
    echo "No more Blogs. Please try again later!.";
}
?>
...
<div style="background-color: white;" class="card">
  <div class="card-header">
    ...
    <b><span style="font-size: 20px; margin-left: 12px; padding-top: 15px;"><?php echo $row["name"];?></span></b>
                
<div style="font-size: 13px; margin-left: 12px;" class="card-footer"><i class="far fa-clock"></i>&nbsp;<?php echo time_ago_in_php($time);?></div>
<hr>
  <div class="card-body">
    <a style="color: black;" href="post_view.php?id='<?php echo $id; ?>'"><b><h5 style="font-size: 21px; margin-left: 12px; font-weight: 5px;" class="card-title"><?php echo $row["title"]; ?></h5></a></b>
    ...
    <hr>
<ul class="nav">
<li><div style="font-size: 14px;" class="card-footer"><i class="fa fa-eye"></i>&nbsp;<?php echo $views." Views • "?></div></li>
<li><div style="font-size: 14px;" class="card-footer"><?php echo $row["name"]." confessed this"; ?></div></li>
</ul>
    <hr>
