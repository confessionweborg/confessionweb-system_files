...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.13/css/all.css" integrity="sha384-DNOHZ68U8hZfKXOrtjWvjxusGo9WQnrNx2sqG0tfsghAvtVlRW3tvkXWZh58N9jp" crossorigin="anonymous">
  ...
  <title>Confession | ConfessionWeb</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>CW</b>Confessions</span>
    </a>
...
<?php 
    ...
    echo "<a href='signin.php'>"."Login now to read more!"."</a>";
}
?>
...
?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li>
          <a href="home.php">
            <i class="fa fa-dashboard"></i> <span style="font-size: 13px;">News Feed</span>
...
if ($result->num_rows > 0) {
  ...
  <div class="px-2 py-2">
    <p style="font-size: 15px;" class="mb-0 small font-weight-medium text-uppercase mb-1 lts-2px">
      <small style="font-size: 10px;"><?php echo "Confessed by ".$row["name"]; ?></small><br>
      <?php echo "@".$row["name"]; ?>
    </p>
