...
<li class="active treeview"><a href="user_blog.php"><i class="fa fa-rss"></i> <span>Blogs</span></a></li>
        ...
        <section class="col-lg-10 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Write Your Blog</h3>
              <!-- tools box -->
            ...
            <div class="box-body">
              <form action="blog_post.php" method="post">
                ...
                <div>
                  <textarea style="resize: none; height: 140px; width: 100%; border-color: lightblue;" type="text" name="bpost" class="textarea" placeholder="Write your Blog here, <?php echo $username ?>..."
                            style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
                </div>
                <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-default" id="sendEmail">Blog
...
<center><section class="content-header">
      <h1><i class="fas fa-rss-square"></i>&nbsp;
        Your Blogs (<?php 
