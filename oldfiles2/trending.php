  ...
  <nav style="position: fixed;
    ...
    <div class="nav-wrapper container col-7"><a id="logo-container" style="color: black; text-decoration: none; font-size: 25px;" href="home.php" class=""><img style="border-radius: 10%; width: 30px; height: 30px;" src="feed/images/logo.png"></a>
      <ul id="nav-mobile" class="right">
        <li class="active"><a class="text-muted" style="color: black; text-decoration: none;" href="home.php"><i style="color: #3f3f3f;" class="fas fa-newspaper"></i>&nbsp;News Feed</a></li>
...
<div>
  ...
  <li class="nav-item">
    <a class="nav-link text-muted" href="home.php"><i class="far fa-newspaper"></i>&nbsp;News Feed</a>
  </li>
  <li class="nav-item active">
    <a style="background-color: #dbdbdb; border-radius: 7px;" class="nav-link active" href="trending.php"><i class="fas fa-check-circle"></i>&nbsp;Trending<span class="badge"><?php 
