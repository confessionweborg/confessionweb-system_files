...
<body style="background-color: #f1f1f1;">
  ...
  <nav style="position: fixed;
    ...
    <div class="nav-wrapper container col-12">
      <a id="logo-container" style="color: black; text-decoration: none; font-size: 25px;" href="home.php" class="">
        <img style="border-radius: 10%; width: 30px; height: 30px;" src="feed/images/logo.png"></a>
      <ul id="nav-mobile" class="right" style="margin-bottom: 0px;">
...
<br>
    ...
    <div class="col-5">
      <div style="width: 600px; margin-left: 15px;" class="shadow-none card">
      <div class="card-body">
...
<?php }?>
        ...
        <b><p class="card-text text-muted"><a style="text-decoration: blue; font-size: 20px; font-family: 'Work Sans', sans-serif;" href="" data-toggle="modal" data-target="#exampleModalCenter">Want to confess something, <?php echo $username."?"; ?><br><small>Confess your experiences, emotions and everything inside you</small></a></p></b>
      </div>
    </div>
...
<form action="home.php" method="GET">
  <input type="text" name="query" placeholder="Search confessions...">
  <input type="submit" name="search" class="btn btn-primary" style="background-color: blue;" value="Search">
</form>
 <br>
<center><b><p><i class="fas fa-search-plus"></i>&nbsp;Search Results</p></b></center>
...
if (isset($_GET['query'])) {
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($conn, "SELECT * FROM posts
            WHERE (`title` LIKE '%".$query."%') OR (`post` LIKE '%".$query."%') LIMIT 3") or die(mysqli_error());
...
<li style="display: inline;"><b><a style="color: black; font-size: 10px;" href="post_view.php?id='<?php echo $id; ?>'"><h4 style="font-size: 15px; font-weight: bold;"><i class="fas fa-link"></i>&nbsp;<?php echo $results['title']; ?></h4></a></b>
<p style="font-size: 12px;"><?php echo "Confessed by ".$results['name']; ?>
<p style="font-size: 15px;"><?php echo substr($results['post'], 0, 200)."..."; ?></p>
</li>
            ...
            echo "Sorry, We didn't find any results."."<br>"."Try to search for something else!";
        }
