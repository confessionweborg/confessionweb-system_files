...
<br>
<center><span style="font-size: 20px;" class="badge badge-primary">Your Blogs (<?php 
$id = isset($_SESSION['id']);
...
<div class="shadow-none card rounded">
      <div style="width: 100%;" class="card-body">
        ...
        <div class="text-muted" style="font-size: 13px; padding-left: 44px;"><i class="far fa-eye"></i>&nbsp;<?php echo $bviews." Views";?></div>
