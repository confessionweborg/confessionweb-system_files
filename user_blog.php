...
if ($result->num_rows > 0) {
  ...
  overflow: auto;"><i style="font-size: 18px; color: blue;" class="fas fa-portrait"></i>&nbsp;&nbsp;<?php echo $username." recently posted "; ?><a style="color: blue; font-size: 15px; width: 20px;" href="post_view.php?id='<?php echo $id; ?>'">"<?php echo $title; ?>"</a> <span style="font-size: 12px;">(<?php echo $views." Views"; ?>)</span>
...
<div style="padding-left: 50px; padding-right: 30px;" class="row">
  <div class="col-sm-8">
    <div class="card">
      <div class="card-body">
...
<center><span style="font-size: 20px;" class="badge badge-success">Write your Blog!</span></center>
<br>
...
<form action="blog_post.php" method="post">
                ...
                <div>
    <textarea name="bpost" type="text" id="editor4"></textarea>
    <script>
      ClassicEditor
        ...
        .catch( error => {
          console.error( error );
              ...
              <button style="float: right; background-color: blue; color: white;" type="submit" class="pull-right btn btn-default" id="sendEmail">Post
