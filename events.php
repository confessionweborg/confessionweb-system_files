...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0"/>
	<title>Events - ConfessionWeb</title>
...
<p style="font-size: 17px; line-height: 4px;">Feeds</p>
  ...
  <li class="nav-item">
    <a style="background-color: #e4e4e4; border-radius: 7px; line-height: 4px;" class="nav-link active" href="events.php"><i class="far fa-calendar-alt"></i>&nbsp;Events</a>
  </li>
  <br>
  <li class="nav-item">
    <button style="background-color: #2b6da;" type="button" class="button button1" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Create an Event</button>
  </li>
...
<center><h4 style="font-size: 30px; font-family: 'q_serif',Georgia,Times,"Times New Roman","Hiragino Kaku Gothic Pro","Meiryo",serif;"><img style="margin-bottom: 10px;" width="55px" height="55px" src="https://png.icons8.com/color/96/000000/event-accepted.png">ConfessionWeb Events</h4></center>



<?php $sql = "SELECT * FROM signup INNER JOIN events ON signup.name = events.name ORDER BY events.event_id DESC";
$result = $conn->query($sql);
...
<?php } ?>
         ...
         <span style="font-size: 17px;"> created an event <a href="event_view.php?event_id=<?php echo $row["event_id"]; ?>"><span style="color: blue;"><?php echo $ename; ?></span></a></span>


<div class="text-muted" style="font-size: 13px; margin-left: 7px;"><?php echo $position; ?></div>

        <div class="text-muted" style="font-size: 11px; margin-left: 7px;"><i class="far fa-clock"></i>&nbsp;<?php echo time_ago_in_phpviews($ctime);?></div>
    </h5>
  </div>
...
<center><span class="text-muted" style="font-size: 40px;"><i class="far fa-calendar-alt"></i></span> <span class="text-muted" style="font-size: 30px;">No Events are Created Yet</span></center>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><img style="margin-bottom: 10px;" width="35px" height="35px" src="https://png.icons8.com/color/96/000000/event-accepted.png">&nbsp;Create an Event</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="create_event.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="etime" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Description:</label>
            <textarea class="form-control" id="editor2" name="description" id="message-text"></textarea>
