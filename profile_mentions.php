...
<div style="font-size: 12px;" class="text-muted"><i style="color: #2b6dad;" class="fas fa-user-tag"></i> <a class="text-muted" href="profile_view.php?name=<?php echo $row["name"]; ?>"><?php echo $row["name"];?></a> mentioned <a class="text-muted" href="profile_view.php?name=<?php echo $username; ?>"><?php echo $username; ?></a> in this post</div>
...
$sql2 = "SELECT * FROM posts WHERE name =".$row["name"];
$result2 = mysqli_query($conn, $sql2);
...
echo "     ".$views_k."k";} else {echo $sum;} ?></span>
...
echo "     ".$views_k;} else {echo $sum;} ?> Views last week</div>
